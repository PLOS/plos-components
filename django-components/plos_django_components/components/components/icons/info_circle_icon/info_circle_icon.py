"""
Component for rendering an information symbol within a circle icon.
"""
...
@register("plos_icon_info_circle")
class InfoCircleIcon(PLOSBaseComponent):
    """
    Renders an information symbol within a circle icon.
    ...
    template_name = "info_circle_icon.html"
    ...
    def get_context_data(  # noqa: D102
        ...
        return {
            ...
            "display": display,
            "field_id": field_id,
            "icon": IconFontSetting.get_info_circle_icon(),
        }
