"""
Component for rendering an exclamation symbol within a circle icon.
"""
...
@register("plos_icon_exclamation_circle")
class ExclamationCircleIcon(PLOSBaseComponent):
    """
    Renders an exclamation symbol within a circle icon.
    ...
    template_name = "exclamation_circle_icon.html"
    ...
    def get_context_data(  # noqa: D102
        ...
        return {
            ...
            "display": display,
            "field_id": field_id,
            "icon": IconFontSetting.get_exclamation_circle_icon(),
        }
